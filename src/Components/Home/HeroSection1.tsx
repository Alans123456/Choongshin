      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col justify-center px-8 sm:px-12 md:px-20 lg:px-32">
            <h2 className="text-amber-100 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light mb-1 md:mb-2">
              {slide.title}
            </h2>
            <h1 className="text-amber-100 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif italic mb-6 md:mb-8 lg:mb-10">
              {slide.subtitle}
            </h1>
            <Link
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-0.5 transition-all duration-500 ${
              index === currentSlide
                ? 'bg-amber-100 w-8 sm:w-10 md:w-12'
                : 'bg-amber-100/30 w-6 sm:w-8 hover:bg-amber-100/50'
            }`}
