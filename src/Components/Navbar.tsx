      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex-1 max-w-2xl mx-8 relative">
            <div className="relative">
              ...
              <input
                ...
                onFocusCapture={(e) =>
                  (e.currentTarget.style.borderColor = "#633B6F")
                }
                onBlurCapture={(e) =>
                  (e.currentTarget.style.borderColor = "#633B6F20")
                }
              />
              <button
                ...
                style={{ backgroundColor: "#F8A61C" }}
                onMouseEnter={(e) =>
                  (e.currentTarget.style.backgroundColor = "#E09519")
                }
                onMouseLeave={(e) =>
            ...
            {showSearchSuggestions &&
              ...
              filteredSuggestions.length > 0 && (
                <div
                  className="absolute top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-md rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto"
                  style={{ border: "1px solid #633B6F20" }}
                >
                  <div className="p-2">
                    <p
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              href="/account"
              className="px-4 py-2 text-white rounded-md transition-all font-medium text-sm shadow-sm"
              style={{ backgroundColor: "#F8A61C" }}
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = "#E09519")
              }
              ...
              >
                ...
                {link.hasDropdown &&
                  ...
                  megaMenuData[link.name] && (
                    <div
                      className="absolute left-0 top-full w-screen max-w-6xl bg-white/95 backdrop-blur-md shadow-xl z-50 p-8"
                      style={{ borderTop: "2px solid #F8A61C" }}
                    >
