        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-2 gap-2">
          ...
          <div className="flex items-center gap-4 md:gap-6 text-sm">
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              <span className="font-medium">Bharatpur-10, Saikshik Marg</span>
            </div>
          </div>
              ...
              {rotatingContent.map((item, index) => (
                <div
                  ...
                  className={`absolute w-full flex items-center justify-center gap-2 transition-all duration-700 ease-in-out ${
                    index === currentIndex ? "opacity-100 translate-y-0" : index < currentIndex ? "opacity-0 -translate-y-8" : "opacity-0 translate-y-8"
                  }`}
                >
          ...
          <div className="hidden md:flex items-center gap-2">
            <a
              href="https://www.facebook.com/choongshingraphics/"
              target="_blank"
            ...
            <a
              href="https://www.tiktok.com/@choongshingraphics"
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 shadow-sm"
              style={{
